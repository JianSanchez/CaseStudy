          ...
          <div class="top-nav" >
            <nav>
              <ul>
                ...
                <li className="color-three flex"><VscChevronRight className="icon"/>Pasengers</li>
                <li className="color-four flex"><VscChevronRight className="icon"/>Confirmation</li>
